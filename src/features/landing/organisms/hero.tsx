...
const Hero: React.FC = () => {
  return (
    ...
    >
      ...
      <div className='absolute right-0 bottom-0 left-0 h-40 from-transparent via-[rgba(233,238,255,0.5)] to-[rgba(202,208,230,0.5)] backdrop-blur-[2px]'></div>
      ...
      <div className='text-center'>
        ...
        <Image
          ...
          priority={true}
          alt='app mockup'
          className='relative z-10 mx-auto mt-12 h-auto w-auto max-w-[480px] object-contain md:mt-16 md:max-w-[440px]'
        />
      </div>
    </section>
  );
