    ...
    <section id='cta' className='mt-10 mb-5 lg:my-20'>
      <div className='relative z-10 mx-auto h-full w-full py-12 sm:py-20'>
        <div className='h-full w-full'>
          <div className='absolute inset-0 -z-10 h-full w-full rounded-3xl bg-[#164E63] bg-[linear-gradient(to_right,#12170f_1px,transparent_1px),linear-gradient(to_bottom,#12170f_1px,transparent_1px)] bg-[size:6rem_4rem] opacity-95'>
